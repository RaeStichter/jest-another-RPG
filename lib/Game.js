...
// The battle() method is the main event of the game that will run an indefinite number of times. Each time, it will either be the Player turn or the Enemy turn. Let's pseudocode exactly what should happen:
